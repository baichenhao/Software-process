...
<body>
	<div class="container">
		<div class="left">
			...
			<div class="choose" id="noticeChoose"  id="noticeTarget">
				<div class="chooseImg">
				...
				<script type="text/javascript">
					...
					$('#addNotice').on('click', function(){
						index=layer.open({
						  ...
						  ,anim: 1 
						  ,content: 
						  	'<div id="addNoticeInfo">'
								+'<table>'
									+'<tr><td class="tdLeft">内容:</td><td><input type="" name=""></td></tr>'
									...
									+'<tr><td class="tdLeft" colspan="2"><button class="addNoticeInfo">提交</button></td></tr>'
								+'</table>'
							+'</div>'
						});   
						parent.$('.addNoticeInfo').on('click',function(){
							layer.close(index);
						});
					});			
				</script>
							  ...
							  ,content: 
							  	'<div id="addNoticeInfo">'
									+'<table>'
										...
										+'<tr><td class="tdLeft">时间:</td><td><input type="" name=""></td></tr>'
										+'<tr><td class="tdLeft">状态:</td><td><input type="" name=""></td></tr>'
										+'<tr><td class="tdLeft" colspan="2"><button class="updateNoticeInfo">修改</button></td></tr>'
									+'</table>'
								+'</div>'
							});   
							parent.$('.updateNoticeInfo').on('click',function(){
								layer.close(index);
							});
						});			
